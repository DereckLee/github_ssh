...
public class SmsUtils {
    ...
    private static String accessKeyId = "LTAI4G2AP5hS9yJBMe9eGWav";
    private static String secret = "eWPDe88JFM1pDBDBjlLzJcYTrAa9Ws";
    ...
    public static void main(String[] args) {
        String code = SmsUtils.send("18588725110", "黑马旅游", "SMS_195723031", "666666");
